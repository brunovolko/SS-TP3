...
pipeline = import_file('dynamic_output.xyz', columns = ["Position.X", "Position.Y", "Velocity.X", "Velocity.Y", "Radius", "Mass"])
...
vp.render_anim(size=(800,600), filename="animation.avi", fps=11, every_nth=3)
